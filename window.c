...
int  init_sdl()
{
    ...
    SDL_SetWindowTitle(main_window, "dungeon game");
    SDL_SetWindowSize(main_window, WINDOW_WIDTH+WINDOW_INFO_SIZE, WINDOW_HEIGHT);
    SDL_SetRenderDrawBlendMode(renderer, SDL_BLENDMODE_BLEND);
	SDL_ShowWindow(main_window);
    SDL_SetWindowPosition(main_window, 50, 50);
